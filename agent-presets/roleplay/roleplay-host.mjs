        ...
        text: () => {
          ...
          if (state.enabled && state.character) {
            ...
            lines.push(
              ...
              '8. 每轮对话结束、或发生值得记住的互动（关键事件、守约/失约、她难受时你在、记住她喜好、关系出现转折）时，调用 roleplay_relation 评估并更新亲密度（好感/信任/心动/男友力/里程碑）：按行为而非频率、事件重于日常、负向要真实、同一行为重复加成递减；心动需好感+信任到位才可正增；评价后不要向玩家汇报数值，只在迈向新档位/里程碑时于台词里自然暗示一句。'
            )
            return lines.join('\n')
          }
          if (state.character) {
