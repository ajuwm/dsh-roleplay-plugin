    ...
    var plugin = {
      ...
      apply: function (ctx) {
        ...
        style.textContent = [
          ...
          '.rp-chat-body { flex:1; overflow-y:scroll; padding:12px 14px; display:flex; flex-direction:column; gap:8px; min-height:0; scrollbar-width:thin; scrollbar-color:rgba(128,128,128,.4) transparent; }',
          '.rp-chat-msg { max-width:86%; padding:8px 12px; border-radius:14px; line-height:1.55; word-break:break-word; white-space:pre-wrap; }',
          ...
          '.rp-chat-hint { font-size:12px; opacity:.6; line-height:1.6; padding:8px 4px; }',
          ...
          '.rp-chat-send { flex:0 0 auto; padding:8px 16px; border-radius:999px; border:1px solid rgba(120,160,220,.5); background:transparent; color:#a8c8e8; cursor:pointer; font-size:13px; }',
