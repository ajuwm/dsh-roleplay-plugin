            ...
            if (g.kind === 'guess') {
              ...
              body = React.createElement('div', null,
                ...
                g.over
                  ...
                  : React.createElement('div', { className: 'rp-game-row' },
                      React.createElement('input', { className: 'rp-game-input', value: input, placeholder: '猜 1-' + g.range + ' 之间的数', onChange: function (e) { setInput(e.target.value) }, onKeyDown: function (e) { if (e.key === 'Enter') go({ n: Number(input) }) } }),
                      React.createElement('button', { className: 'rp-game-go', onClick: function () { go({ n: Number(input) }) } }, '猜')))
              ...
              body = React.createElement('div', null,
                ...
                g.over
                  ...
                  : React.createElement('div', { className: 'rp-game-row' },
                      React.createElement('input', { className: 'rp-game-input', value: input, placeholder: '问一个是/不是的问题,或直接猜', onChange: function (e) { setInput(e.target.value) }, onKeyDown: function (e) { if (e.key === 'Enter') go({ q: input }) } }),
                      React.createElement('button', { className: 'rp-game-go', onClick: function () { go({ q: input }) } }, '提问'),
                      React.createElement('button', { className: 'rp-game-start', onClick: function () { go({ guess: input }) } }, '猜答案')))
            } else if (g.kind === 'ttt') {
              var cells = []
              for (var i = 0; i < 9; i++) {
                (function (idx) {
              ...
              body = React.createElement('div', null,
                ...
                React.createElement('div', { className: 'rp-game-btns' },
                  React.createElement('button', { className: 'rp-game-start', onClick: function () { game.move({ choice: 'truth' }) } }, '💬 真心话'),
                  React.createElement('button', { className: 'rp-game-start', onClick: function () { game.move({ choice: 'dare' }) } }, '🎭 大冒险')))
            }
            return React.createElement('div', { className: 'rp-game' },
