            ...
            return slots.register(
              ...
              function () {
                ...
                return React.createElement('div', { className: 'rp-card' },
                  React.createElement('div', { className: 'rp-card-head', style: { display: 'flex', alignItems: 'center', justifyContent: 'space-between', cursor: 'pointer' }, onClick: function () { cardOpen[1](!cardOpen[0]) } },
                    React.createElement('span', { className: 'rp-card-lab', style: { fontSize: 14, fontWeight: 600 } }, '🎭 角色扮演'),
                    React.createElement('span', null, cardOpen[0] ? '▾' : '▸')),
                  cardOpen[0] ? React.createElement(React.Fragment, null,
