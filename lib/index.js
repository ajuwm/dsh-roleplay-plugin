...
export default {
  ...
  apply(ctx) {
    ...
    async function dispatch(endpoint, payload) {
      ...
      const KNOWN_ENDPOINTS = ['settings-read', 'settings-write', 'chat-targets', 'chat-send', 'chat-poll', 'chat-history', 'notes-list', 'notes-ack', 'game-start', 'game-move', 'game-state', 'game-quit', 'backup-now', 'get-state', 'start', 'stop', 'cards-list', 'cards-load', 'look-desktop', 'shop-buy', 'inventory-use', 'settings-update', 'user-profile-update', 'cards-delete', 'room-start', 'room-stop', 'pet-status', 'pet-start', 'pet-stop']
